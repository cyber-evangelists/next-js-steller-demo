  ...
  return (
    <section className="bg-themeColor">
      <div className="max-w-7xl w-full mx-auto pt-16  min-md:pt-32 ">
        ...
        {/* box */}
        <div className="flex flex-col min-md:flex-row border xs:mx-4 min-md:mx-6 border-bordorColor rounded-3xl">
        ...
        <div className="flex flex-col min-md:flex-row gap-10 mt-8 xs:mx-4 mb-12 min-md:mx-6 min-md:mb-20">
          <div className="min-md:w-4/6 border border-bordorColor flex flex-col p-6 min-md:p-8 rounded-3xl">
            <h3 className="font-bold text-textPrimary text-xl">
              Extensibility
            </h3>
          ...
          <div className="min-md:w-1/3 border border-bordorColor rounded-3xl p-6 min-md:p-8">
            <h3 className="font-bold text-textPrimary text-xl">
              Infinite Options
            </h3>
            <span className="min-md:w-3/4">
